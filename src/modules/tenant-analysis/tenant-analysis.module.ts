...
@Module({
  ...
  providers: [TenantAnalysisService, CellereService, InfoSimplesService, MockAnalysisService],
  exports: [TenantAnalysisService, CellereService, InfoSimplesService, MockAnalysisService],
})
